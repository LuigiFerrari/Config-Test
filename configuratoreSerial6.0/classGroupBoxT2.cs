...
{
    internal class classGroupBoxT2
    {
        frmTermoT2 mainForm;
        int peogressivo;
        int richiestoDa;
        ...
        public classGroupBoxT2(gbOxConfig GroupBpoxInfo, frmTermoT2 gForm)
        {
            int i;
            int j;
            mainForm = gForm;
        ...
        private void ValueChanged(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < GroupBpox.cfgUpDown.Length; i++)
            {
                if (sender == GroupBpox.cfgUpDown[i].numUpDown)
                {
                    ...
                    global.glbfrmT2.campoDinamico(GroupBpox.cfgUpDown[i].numParametro, txData);
