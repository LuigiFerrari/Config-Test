...
new sVocParametri() {NomeParametro="KF_LOGIC_DI5_NANC",IDParametro=14},
...
// -------------
new sVocParametri() {NomeParametro="KF_INCR_ZM_RISC_TIPO1_MBUS",IDParametro=101},
new sVocParametri() {NomeParametro="KF_INCR_ZM_RAFF_TIPO1_MBUS",IDParametro=102},
new sVocParametri() {NomeParametro="KF_INCR_ZM_RISC_TIPO2_MBUS",IDParametro=103},
new sVocParametri() {NomeParametro="KF_INCR_ZM_RAFF_TIPO2_MBUS",IDParametro=104},
new sVocParametri() {NomeParametro="KF_ECONOMY_TYPE_MBUS",IDParametro=105},
// -------------
new sVocParametri() {NomeParametro="KF_TIPO_DISPOSITIVO_MS",IDParametro=106},
new sVocParametri() {NomeParametro="KF_INDIRIZZO",IDParametro=107},
new sVocParametri() {NomeParametro="KF_BAUDRATE",IDParametro=108},
new sVocParametri() {NomeParametro="KF_PARITA",IDParametro=109},
new sVocParametri() {NomeParametro="KF_BITSTOP",IDParametro=110},
// -------------
new sVocParametri() {NomeParametro="KF_INDIRIZZO_SLAVE",IDParametro=111},
// -------------
new sVocParametri() {NomeParametro="KF_KV_FORZATURA_SETPOINT_ONOFF",IDParametro=112},
new sVocParametri() {NomeParametro="KF_KV_VALORE_FORZATURA_SETPOINT",IDParametro=113},
new sVocParametri() {NomeParametro="KF_KV_CMD_VENTILATORE",IDParametro=114},
new sVocParametri() {NomeParametro="KF_KV_CMD_RISCALDAMENTO",IDParametro=115},
new sVocParametri() {NomeParametro="KF_KV_CMD_RAFFREDDAMENTO",IDParametro=116},
new sVocParametri() {NomeParametro="KF_KV_CMD_SERRANDA",IDParametro=117},
new sVocParametri() {NomeParametro="KF_KV_PERC_VENTILATORE",IDParametro=118},
new sVocParametri() {NomeParametro="KF_KV_PERC_RISCALDAMENTO",IDParametro=119},
new sVocParametri() {NomeParametro="KF_KV_PERC_RAFFREDDAMENTO",IDParametro=120},
new sVocParametri() {NomeParametro="KF_KV_PERC_SERRANDA",IDParametro=121},
new sVocParametri() {NomeParametro="KF_MBUS_FORZATURA_VENTILATORE",IDParametro=122},
new sVocParametri() {NomeParametro="KF_MBUS_FORZATURA_RISCALDAMENTO",IDParametro=123},
new sVocParametri() {NomeParametro="KF_MBUS_FORZATURA_RAFFREDDAMENTO",IDParametro=124},
new sVocParametri() {NomeParametro="KF_MBUS_FORZATURA_SERRANDA",IDParametro=125},
