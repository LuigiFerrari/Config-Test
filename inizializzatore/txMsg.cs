...
namespace configuratore
{
    ...
    internal class txMsg
    {
        ...
        static public void requireInfo()
        {
            ...
            txBuffer[Costanti.FANCAS] = 0;
            txBuffer[Costanti.MSG_VERSION0] = 0;
            txBuffer[Costanti.MSG_VERSION1] = 0;
            txBuffer[Costanti.RESERVED_2] = 0;
            txBuffer[Costanti.DATASETGET] = Costanti.DATAGET;
            txBuffer[Costanti.MSG_H] = 0;
            txBuffer[Costanti.MSG_L] = 0;
        ...
        static public void txMessageGeneric(byte[] msg)
        {
            clsSerial.txData(msg, msg.Length);
        }
    }
}
